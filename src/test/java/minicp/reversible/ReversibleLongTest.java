...
public class ReversibleLongTest {

    {
        Trail trail = new Trail();
        ReversibleLong a = new ReversibleLong(trail,7);
        ReversibleLong b = new ReversibleLong(trail,13);
    ...
    public void testExample() {
        ...
        ReversibleLong a = new ReversibleLong(trail,5);
        ReversibleLong b = new ReversibleLong(trail,9);
    ...
    @Test
    public void testReversibleLong() {
        Trail trail = new Trail();
        ReversibleLong a = new ReversibleLong(trail,5);
        ReversibleLong b = new ReversibleLong(trail,5);
    ...
    public void testPopAll() {
        ...
        ReversibleLong c = new ReversibleLong(trail,5);
